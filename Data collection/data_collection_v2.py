...
from adafruit_bno08x import (  # type: ignore[import-not-found]
    ...
    BNO_REPORT_ARVR_STABILIZED_GAME_ROTATION_VECTOR,  # ← was BNO_REPORT_GAME_ROTATION_VECTOR
...
class _FastIMU:
    ...
    def read(self) -> Optional[dict]:
        try:
            ...
            quat = self._bno._readings.get(BNO_REPORT_ARVR_STABILIZED_GAME_ROTATION_VECTOR)  # ← was BNO_REPORT_GAME_ROTATION_VECTOR
        except KeyError:
